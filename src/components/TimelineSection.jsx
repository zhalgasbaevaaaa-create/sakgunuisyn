...
import { Clock, Calendar, Swords, Info, ChevronRight, Filter, Maximize2, Minimize2 } from 'lucide-react';

export default function TimelineSection({ onToggleFullscreen, isFullscreen }) {
  ...
  return (
    <section id="timeline" className={`py-16 px-4 sm:px-6 lg:px-8 bg-obsidian-950 border-t border-gold-500/10 ${isFullscreen ? 'fullscreen-mode' : ''}`}>
